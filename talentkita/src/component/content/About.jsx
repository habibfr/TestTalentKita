      ...
      <div className="">
        <div className="container flex max-w-4xl items-center mx-auto py-12">
          <div className="">
            ...
            <div className="py-6">
              <button className="px-6 py-2 mr-5 bg-orange-500 rounded-full">
                Sign Up
              </button>
              <button className="px-6 py-[0.4rem] border-2 border-orange-500 rounded-full">
                Sign Up
              </button>
            </div>
            <div className="font-extralight text-xs opacity-70 mt-6">Worrked with 100+ companies</div>
